...
export const aboutClinicData: Record<'th' | 'en', AboutClinicData> = {
  th: {
    ...
    aboutText: "ทีมแพทย์ของเรา ผู้มีประสบการณ์กว่า 10 ปี เราเน้นการดูแลแบบ Pawplan คือการวางแผนสุขภาพในระยะยาว ไม่ใช่เพียงแค่การรักษาอาการป่วยฉุกเฉินเท่านั้น",
  ...
  en: {
    ...
    aboutText: "Our team is with over 10 years of experience. We focus on the Pawplan approach — long-term health planning, not just emergency treatment.",
