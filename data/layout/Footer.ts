...
export const footerData: Record<'th' | 'en', FooterData> = {
  th: {
    ...
    address: "52 347 ถนน พหลโยธิน ตำบล หลักหก อำเภอเมืองปทุมธานี ปทุมธานี 12000",
    contactUs: "ติดต่อเรา",
    phone: "📞 โทร: 098-197-2742",
    email: "📧 pawplanc@gmail.com",
    lineId: "Line ID: @811lgnxe",
    hours: "เวลาทำการ",
    ...
    copyright: "© 2025 Pawplan Clinic. สงวนลิขสิทธิ์ทั้งหมด"
  },
  en: {
    clinicName: "🐾 Pawplan Clinic",
    tagline: "Plan the best health for your pet",
    address: "52/347 Phahonyothin Road, Lak Hok Subdistrict, Mueang Pathum Thani District, Pathum Thani 12000, Thailand",
    contactUs: "Contact Us",
    phone: "📞 Tel: 098-197-2742",
    email: "📧 pawplanc@gmail.com",
    lineId: "Line ID: @811lgnxe",
    hours: "Opening Hours",
